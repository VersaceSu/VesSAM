...
class VesselDataset(Dataset):
    def __init__(self, dataset_name, data_dir, split="train", transform=None, max_branch_points=16,
                 max_mid_points=16):
        """
        ...
        self.dataset_info_path = os.path.join(self.data_dir, "dataset_info.json")
